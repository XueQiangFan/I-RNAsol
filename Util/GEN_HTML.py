...
class GEN_HTML:
    def __init__(self, nucle_name, result_path):
        self.file_path = os.path.join(result_path, nucle_name+".sa")
    ...
    def visualization_RSA_result(self):
        ...
        plt.xlabel('Nucleotide index', fontsize=7)
        plt.ylabel('I-RNAsol predicted RSA', fontsize=7)
    ...
    def generate_html(self):
        ...
        fw.write('''<tr><td>\n''')
        title = '''  <h1 align="center">I-RNAsol result for '''+self.nucle_name+'''</h1>\n'''
        fw.write(title)
        fw.write('''  <tr><td>\n''')
        fw.write('''   <br/>\n''')
        ...
        fw.write('''<tr><td><b><i>No.</i></b> is the position of each nucleotide in your RNA. </td><tr>\n''')
        fw.write('''<tr><td><b><i>AA</i></b> is the name of each nucleotide in your RNA. </td></tr>\n''')
        fw.write('''   <tr><td><b><i>RSA</i></b> is the predicted relative accessible surface area of each nucleotide in your RNA.</td><tr>\n''')
        fw.write('''   <tr><td><b><i>ASA</i></b> is the predicted accessible surface area of each nucleotide in your RNA.</td><tr>\n''')
        fw.write('''</table>\n''')
        fw.write('''<br/>\n''')
