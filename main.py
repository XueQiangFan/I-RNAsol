...
import numpy as np
import torch
from Util.feature_extract import OneHotPSFMSSGetWindowPadheadfoot
from MVCADNN import BiLSTM_SE_Net
from Util.WriteFile import appendWrite
from Util.GEN_HTML import GEN_HTML
from Util.feature_generate import FeaturesGeneration
import warnings
...
def tester(nucle_name, result_dir):
    ...
    saved_model = save_model + 'MVCADNNopt'
